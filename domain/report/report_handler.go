...
type updateDeliveryNumberFunc func(context.Context, RequestReportUpdate) (ResponseReportDetail, error)

func (fn updateDeliveryNumberFunc) UpdateDeliveryNumber(ctx context.Context, req RequestReportUpdate) (ResponseReportDetail, error) {
	return fn(ctx, req)
}

func UpdateDeliveryNumberHandler(svc updateDeliveryNumberFunc) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		res, err := svc.UpdateDeliveryNumber(c.Request().Context(), req)
...
type updateEquipmentDetailsFunc func(context.Context, RequestReportUpdate) (ResponseReportDetail, error)

func (fn updateEquipmentDetailsFunc) UpdateEquipmentDetails(ctx context.Context, req RequestReportUpdate) (ResponseReportDetail, error) {
	return fn(ctx, req)
}

func UpdateEquipmentDetailsHandler(svc updateEquipmentDetailsFunc) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		res, err := svc.UpdateEquipmentDetails(c.Request().Context(), req)
